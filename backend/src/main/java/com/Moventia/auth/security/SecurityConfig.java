 ...
 *  - CORS open for local React dev server (localhost:5173)
...
public class SecurityConfig {
    ...
    private final CustomUserDetailsService userDetailsService; // ← inject directly

    @Value("${moventia.frontend.url}")
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(org.springframework.http.HttpMethod.GET, "/api//api/favorites").permitAll()
                        .requestMatchers(org.springframework.http.HttpMethod.GET, "/api/reviews/recent").permitAll()
                        .requestMatchers(org.springframework.http.HttpMethod.GET, "/api/reviews/movie/**").permitAll()
